import { Message, NetworkId, Schema, Uuid } from "ubiq";
...
class PropertyDictionary {
    ...
    append(keys, values) {
        ...
        const set = function (key, value, dict) {
            if (value === "") {
...
export class RoomServer extends EventEmitter {
    ...
    updateStatus() {
        ...
        var structuredLog = JSON.stringify(this.status, (key, value) => typeof value === "bigint" ? value.toString() : value);
    ...
    onConnection(wrapped /*| WebSocketConnectionWrapper*/) {
