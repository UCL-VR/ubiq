...
{
    public class _32_AvatarWithSampleHints : MonoBehaviour, INetworkSpawnable
    {
        ...
        private void Update()
        {
            ...
            // if (avatar.IsLocal)
            // {
            //     if (avatar.input.TryGet(out IHeadAndHandsProvider p))
            //     {
            //         if (p.head.valid)
            //         {
            //             message.position = p.head.value;
            //             message.rotation = p.head.value;
            //         }
            //     }
            ...
            //     context.SendJson(localSpaceMessage);
            // }
        }
